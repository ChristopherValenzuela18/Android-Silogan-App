...
import com.dubai.shopping.activity.AdminCategoryActivity;
...
private DatabaseReference productsRef;
    ...
    private void deletethisproduct()
    {
      productsRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
          ...
          {
              Toast.makeText(AdminMaintainProductsActivity2.this, "The Food Is Deleted Successfully", Toast.LENGTH_SHORT).show();
              Intent intent = new Intent(AdminMaintainProductsActivity2.this, AdminCategoryActivity.class);
